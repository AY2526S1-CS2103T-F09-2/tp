...
public class AddLessonCommandParserTest {
    ...
    public void parse_invalidDate_throwsParseException() {
        String input = " 1 d/2025-13-01"; // Invalid month
        assertThrows(ParseException.class, () -> parser.parse(input));
    }

    @Test
    public void parse_invalidDateFormat_throwsParseException() {
        String input = " 1 d/01-11-2025"; // Wrong format
        assertThrows(ParseException.class, () -> parser.parse(input));
    }

    @Test
    public void parse_pastDate_throwsParseException() {
        String input = " 1 d/2020-11-02"; // Past date
        assertThrows(ParseException.class, () -> parser.parse(input));
    }

    @Test
    public void parse_invalidInterval_throwsParseException() {
        String input = " 1 d/2025-11-02 every/abc";
        assertThrows(ParseException.class, () -> parser.parse(input));
    }
    ...
    public void parse_zeroInterval_throwsParseException() {
        String input = " 1 d/2025-11-02 every/0";
        assertThrows(ParseException.class, () -> parser.parse(input));
    }

    @Test
    public void parse_invalidIndex_throwsParseException() {
        String input = " 0 d/2025-11-02"; // Index must be positive
        assertThrows(ParseException.class, () -> parser.parse(input));
    }
