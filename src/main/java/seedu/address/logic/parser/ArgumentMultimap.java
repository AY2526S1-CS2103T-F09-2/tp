...
public class ArgumentMultimap {
    ...
    /**
     * Returns the last value of {@code prefix}, or {@code defaultValue} if the prefix does not exist
     * or has no values.
     */
    public Optional<String> getValueWithDefault(Prefix prefix, String defaultValue) {
        List<String> values = getAllValues(prefix);
