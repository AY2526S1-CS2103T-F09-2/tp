...
We do not allow the students to overpay the lesson. In other words, the payment status should not go below 0. This is because pre-payment is an unpopular option in payment. However, recording overpayment is comming soon in future versions.
