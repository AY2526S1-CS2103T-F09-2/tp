...
* You may provide the `every/` identifier at most once. Providing every/ more than once (for example `addLesson 1 d/2025-11-13 every/7 every/14`) will result in an error and the lesson will not be added
